...
namespace metadata
{
	struct GenericClassMethod
	{
		...
		Il2CppMetadataMethodDefinitionHandle method;
	...
	public:
		...
		const GenericClassMethod* FindImplMethod(const Il2CppType* containerType, const Il2CppMetadataMethodDefinitionHandle methodHandle, bool throwExceptionIfNotFind = true);
	...
	private:
		...
		void ApplyOverrideMethod(const GenericClassMethod* beOverrideParentMethod, const Il2CppMetadataMethodDefinitionHandle overrideMethodHandle, uint16_t checkOverrideMaxIdx);
		void ApplyExplicitOverride(const std::vector<uint16_t>& implInterfaceOffsetIdxs, Int32ToUin16Map& explicitImplToken2Slots, const Il2CppType* declaringType,
			const Il2CppMetadataMethodDefinitionHandle decalringMethod, const Il2CppType* implType, const Il2CppMetadataMethodDefinitionHandle implMethod);
		void ApplyAOTInterfaceExplicitOverride(const std::vector<uint16_t>& implInterfaceOffsetIdxs, Int32ToUin16Map& explicitImplToken2Slots, const Il2CppType* intfType,
			const Il2CppType* implType, const Il2CppMetadataMethodDefinitionHandle implMethodHandle);
		...
		Il2CppMetadataTypeHandle _typeHandle;
		Il2CppTypeDefinition _typeDef;
